...
<head>
    ...
    <link rel="stylesheet" href="{{asset('template/main/assets/css/pages/error.css')}}">
</head>
    ...
    <div id="error">
        ...
        <div class="error-page container">
            <div class="col-md-8 col-12 offset-md-2">
                <img class="img-error" src="{{asset('template/main/assets/images/samples/error-404.png')}}" alt="Not Found">
                <div class="text-center">
                    <h1 class="error-title">TIDAK DITEMUKAN</h1>
                    <p class='fs-5 text-gray-600'>Halaman yang Anda cari tidak ditemukan.</p>
                    <a href="javascript:history.back()" class="btn btn-lg btn-outline-primary mt-3 mb-5">Go Home</a>
                </div>
            </div>
        </div>
    </div>
