                        ...
                        <div class="row">
                            <div class="col-md-3 text-center mb-5" style="margin-right: 100px;">
                                @if(!empty($user->profile))
                                    <img src="{{ asset('template/custom/img_upload/profile/'.$user->profile) }}" alt="" style="width: 230px; height:230px; object-fit:cover;">
                                @else
                                        ...
                                        <tbody>
                                            <tr>
                                                <div class="row">
                                                    ...
                                                    <th>{{ $user->nik ? $user->nik : 'Belum Diisi' }}</th>
                                                </div>
                                            </tr>
                                            <tr>
                                                <div class="row">
                                                    ...
                                                    <td>{{ $user->fullname ? $user->fullname : 'Belum Diisi' }}</td>
                                                </div>
                                            </tr>
                                            <tr>
                                                <div class="row">
                                                    ...
                                                    <td class="col-md-1" style="padding-right: 10px;">:</td>
                                                    <td>{{ $user->place_of_birth ? $user->place_of_birth : 'Belum Diisi' }} / {{ $user->date_of_birth ? tgl_indo($user->date_of_birth) : 'Belum Diisi' }}</td>
                                                </div>
                                            </tr>
                                            <tr>
                                                <div class="row">
                                            ...
                                            <tr>
                                                <div class="row">
                                                    ...
                                                    <td class="col-md-1" style="padding-right: 10px;">:</td>
                                                    <td>{{ $user->religion ? $user->religion : 'Belum Diisi' }}</td>
                                                </div>
                                            </tr>
                                            <tr>
                                                <div class="row">
                                                    ...
                                                    <td class="col-md-1" style="padding-right: 10px;">:</td>
                                                    <td>{{ $user->marital_status ? $user->marital_status->w_status : 'Belum Diisi' }}</td>
                                                </div>
                                            </tr>
                                            <tr>
                                                <div class="row">
                                                    ...
                                                    <td class="col-md-1" style="padding-right: 10px;">:</td>
                                                    <td>{{ $user->profession ? $user->profession : 'Belum Diisi' }}</td>
                                                </div>
                                            </tr>
                                            <tr>
                                                <div class="row">
                                                    ...
                                                    <td class="col-md-1" style="padding-right: 10px;">:</td>
                                                    <td>{{ $user->created_at ? $user->created_at : 'Belum Diisi' }}</td>
                                                </div>
                                            </tr>
                                            <tr>
                                                <div class="row">
                                                    ...
                                                    <td class="col-md-1" style="padding-right: 10px;">:</td>
                                                    <td>{{ $user->detail_address ? $user->detail_address : 'Belum Diisi' }}</td>
                                                </div>
                                            </tr>
                                        </tbody>
                                    </table>
