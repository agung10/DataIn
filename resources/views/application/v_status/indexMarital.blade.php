    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Data Status</h3>
                <p class="text-subtitle text-muted">Hubungan Dalam Pernikahan</p>
            </div>
    ...
    <section class="section">
        <div class="row">
            <div class="col-12 col-md-4">
                <form method="POST" action="{{ route('status_pernikahan.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="card">
                        <div class="card-body">
                            <label class="mb-2">Status Hubungan Dalam Pernikahan: </label>
                            <div class="form-group">
                                <input type="text" class="form-control @error('w_status') is-invalid @enderror" name=" w_status" autofocus placeholder="Masukkan status">
                ...
                <div class="card">
                    <div class="card-body">
                        <table class="table table-striped" id="table1">
                            ...
                            <tbody>
                                @foreach($marital_statuses as $res)
                                <tr class="text-center">
                                    ...
                                    <td class="text-center">
                                        ...
                                        <button class="btn btn-sm btn-danger openModalDelete" data-uri="{{ route('status_pernikahan.destroy', $res->id) }}">
        ...
        <div class="modal-content">
            ...
            <form id="formEditStatus" method="POST" action="" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <label class="mb-2">Status Hubungan Dalam Pernikahan: </label>
                    <div class="form-group">
                        <input type="text" class="form-control" id="w_status" name="w_status" required>
                    </div>
                </div>
...
<script>
    ...
    $(document).on('click', '.edit', function(e) {
        ...
        console.log(id)
        $.ajax({
            url: "{{ url('getDataPernikahan') }}/" + id,
            dataType: "JSON",
            success: function(data) {
                if (data != "") {
                    $('#w_status').val(data.w_status);
                    $('#modalStatusEdit').click();
                    $('#formEditStatus').attr("action", "{{ url('status_pernikahan/') }}/" + id) + "/update";
